                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <hr>
                                        <h4>Loyality Point Setting:</h4>
                                        <hr>

                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">AED 1 is equal to</label>
                                            <div class="col-sm-10 col-md-4">
                                                {!! Form::text($result['settings'][129]->name, $result['settings'][129]->value, array('class'=>'form-control', 'id'=>$result['settings'][129]->name)) !!}<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">
                                                Loyality points Conversion</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Referral Zpoints:</label>
                                            <div class="col-sm-10 col-md-4">
                                                {!! Form::text($result['settings'][130]->name, $result['settings'][130]->value, array('class'=>'form-control', 'id'=>$result['settings'][130]->name)) !!}<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">
                                                Referral Zpoints Conversion</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Earned Zpoints Per Order(Silver):</label>
                                            <div class="col-sm-10 col-md-4">
                                                {!! Form::text($result['settings'][131]->name, $result['settings'][131]->value, array('class'=>'form-control', 'id'=>$result['settings'][131]->name)) !!}<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">
                                                    this number treated as %(percentage) of the total price of the order
                                                </span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Earned Zpoints Per Order(Gold):</label>
                                            <div class="col-sm-10 col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Earned Zpoints Per Order(Platinum):</label>
                                            <div class="col-sm-10 col-md-4">
