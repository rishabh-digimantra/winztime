                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Whatsapp URL<!-- {{ trans('labels.googleLink') }} --></label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text($result['settings'][52]->name,  $result['settings'][52]->value, array('class'=>'form-control', 'id'=>$result['settings'][52]->name)) !!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;"><!-- {{ trans('labels.googleLinkText') }} -->Please enter your 'Whatsapp URL' here.</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Instagram URL<!-- {{ trans('labels.linkedLink') }} --></label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text($result['settings'][54]->name,  $result['settings'][54]->value, array('class'=>'form-control', 'id'=>$result['settings'][54]->name)) !!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;"><!-- {{ trans('labels.linkedLinkText') }} -->Please enter your 'Instagram URL' here.</span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Youtube URL</label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text($result['settings'][128]->name,  $result['settings'][128]->value, array('class'=>'form-control', 'id'=>$result['settings'][128]->name)) !!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">Please enter your 'Youtube URL' here.<!-- {{ trans('labels.linkedLinkText') }} --></span>
                                                </div>
                                            </div>
                                            <div class="form-group">
