  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview {{ Request::is('admin/home_winners') ? 'active' : '' }} ">
        <a href="{{ URL::to('admin/home_winners')}}"><i class="fa fa-trophy"></i> {{ trans('labels.Winners') }}</a>
      </li>

      <li class="treeview {{ Request::is('admin/winner-email') ? 'active' : '' }} ">
        <a href="{{ URL::to('admin/campaign/winner-email')}}"><i class="fa fa-trophy"></i> Winner Email</a>
      </li>


      <li class="treeview {{ Request::is('admin/sendnotifications') ? 'active' : '' }} ">
        <a href="{{ URL::to('admin/sendnotifications')}}"><i class="fa fa-trophy"></i> Notification </a>
      </li>
