                                 ...
                                 <div class="col-xs-12">
                                    <table id="datatable" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th>Campaign code</th>
                                            <th>@sortablelink('start_date', trans('Start date') )</th>
                                            <th>@sortablelink('end_date', trans('End date') )</th>
                                            <th>@sortablelink('product_id', trans('Product') )</th>
                                            <th>@sortablelink('reward_id', trans('Reward') )</th>
                                        ...
                                        @if($campaigns !== null)
                                            @foreach ($campaigns as $key=>$campaign)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>LU-{{ sequenceNumber($campaign->id) }}</td>
                                                    ...
                                                    <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{ url('admin/campaign/edit')}}/{{$campaign->id}}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
