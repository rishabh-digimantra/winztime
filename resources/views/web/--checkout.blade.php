...
<section class="pro-content main-section">
 ...
 <!-- <div class="container"> -->
   <div class="row">
     ...
     <div class="col-12 col-xl-8 checkout-left contFormWrp">
                     ...
                     <div class="form-row">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <select name="city"  class="form-control field-validate" required="required">
                    ...
                    <table class="table top-table">
                      ...
                      <tbody  @if(session::get('out_of_stock') == 1 and session::get('out_of_stock_product') == $products->products_id)style="  box-shadow: 0 20px 50px rgba(0,0,0,.5); border:2px solid #FF9999;"@endif>
                        ...
                        <tr class="d-flex">
                          ...
                          <td class="col-12 col-md-1 item-detail-left">
                         ...
                         <td class="item-price col-12 col-md-2">
                            <img src="{{asset('images/'.$products->reward[0]->reward_image)}}">
                        </td>
                        <td class="col-12 col-md-3"> 
                          <div class="item-detail">
                            <sup>Reward</sup>
