...
<div class="product product6">
  <article>
   ...
   <!--  -->
    <h3 class="title text-center"><a href="{{ URL::to('/product-detail/'.$products->products_slug)}}" products_id ="{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" class="swipe-to-top modal_show">{{$products->products_name}}</a></h3>
     <p>
      <?php
