...
class Setting extends Model
{
    ...
    public function getSettingsByName($index)
    {
        $setting = DB::table('settings')->where('name', $index)->first();
        return $setting;
    }
