...
class Order extends Model
{
    ...
    public static function ticketInfo($product_id,$campaign_id,$orders_id)
    {
    ...
    public static function lpointsInfo($customers_id,$orders_id,$type)
    {
        $lpoints_Data = DB::table('lpoints')
                    ->where([
    ...
    public static function getOrderProductTickets($order_id,$products_id,$customers_id)
    {
        $tickets= DB::table('tickets')->where('customers_id',$customers_id)->where('orders_id',$order_id)->where('products_id',$products_id)->get();
        $tickets = $tickets->SortByDesc('type');
        return  $tickets;
    }
    public static function getOrderTickets($order_id,$customers_id)
    {
        $tickets= DB::table('tickets')->where('customers_id',$customers_id)->where('orders_id',$order_id)->get();
        $tickets = $tickets->SortByDesc('type');
        return  $tickets;
    }
    public static function getOrderTicketsCount($order_id,$customers_id)
    {
        $tickets= DB::table('tickets')->where('customers_id',$customers_id)->where('orders_id',$order_id)->count();
        return  $tickets;
    }
    public static function getOrderProductTicketsCount($order_id,$products_id,$customers_id)
    {
        $tickets= DB::table('tickets')->where('customers_id',$customers_id)->where('orders_id',$order_id)->where('products_id',$products_id)->count();
        return  $tickets;
    }
    ...
    public static function getOrderPrice($orders_id)
    {
       $data =  DB::table('orders')->where('orders_id',$orders_id)->get();
        return $data;
    }
}
