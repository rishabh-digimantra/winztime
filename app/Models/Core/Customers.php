...

{
    ...
    public function addresses_new($id){
    ...
    public function deleteNewAddresses($request){

        $address_book_id    =   $request->address_book_id;

        DB::table('addresses')->where('id','=', $address_book_id)->delete();
