...
class Products extends Model
{
    ...
    public function products($data)
    {
        ...
        if ($type == "wishlist") {
            $categories->LeftJoin('liked_products', 'liked_products.liked_products_id', '=', 'products.products_id')
                ->select('products.*', 'image_categories.path as image_path', 'products_description.*', 'manufacturers.*', 'manufacturers_info.manufacturers_url','liked_products.campaign_id');
        }
        //parameter special
        elseif ($type == "special") {
    ...
    /**
     * Get the product description that 
     */
    ...
    /**
     * Get the ProductImage according to  that 
     */
    public function ProductImage()
    {
        return $this->hasOne(ImageCategory::class, 'image_id', 'products_image')->latest();
    }

    public function getReward()
    {
        return $this->hasOne(Reward::class, 'image_id', 'products_image')->latest();
    }
}
