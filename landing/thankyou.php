...
<div class="mainWrapper">
	...
	<section class="main-section home-section-five thankyouPg">
			...
			<div class="">
				...
				<div class="row align-center d-flex justify-content-center">
					...
					<div class="col-md-4">
						...
						<figure class="mascotImgFigure mascotImgFigure2">
					...
					<div class="col-md-4">
						<a href="/" title="" class="logo"><img src="assets/images/logo.png"></a>
						<p class="text-center customText"><span class="spanNew">Thanks for registering!</span>We're very happy to have you as a Winztime Member.<span class="span2"><strong> Please stay tuned as we will announce the winners soon</strong> </span> 
